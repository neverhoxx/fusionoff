...
export default function CasesAdminProductsList({ products }: { products: Product[] }) {
    const [items, setItems] = useState(products);
    const [editing, setEditing] = useState<Product | null>(null);

    const handleDelete = async (id: number) => {
        const res = await fetch(`/api/products/cases/${id}`, { method: "DELETE" });
    ...
    const handleSave = async (
        ...
        const res = await fetch(`/api/products/cases/${updated.id}`, {
            method: "PATCH",
